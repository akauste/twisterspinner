const SVGDial = () => {
  ...
  return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="-100 -100 200 200" style={{width: 200, height: 200}}>
    ...
    { spots.map(s => s) }
    <g id="body-figure">
      <circle cx={0} cy={-50} r={10} fill='none' stroke="black" strokeWidth={1} />
      <line x1={0} y1={0} x2={0} y2={-40} stroke="black" strokeWidth={1} />
      <line x1={0} y1={-30} x2={-30} y2={-50} stroke="black" strokeWidth={1} />
      <line x1={0} y1={-30} x2={30} y2={-50} stroke="black" strokeWidth={1} />
      <line x1={0} y1={0} x2={30} y2={60} stroke="black" strokeWidth={1} />
      <line x1={0} y1={0} x2={-30} y2={60} stroke="black" strokeWidth={1} />
    </g>
    <g id="dial">
      <line x1={0} y1={0} x2={Math.sin(2*Math.PI/360*180)*90} y2={-Math.cos(2*Math.PI/360*180)*90} stroke='black' strokeWidth={8} />
    </g>
  </svg>);
};
